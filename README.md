...
<head>
  ...
  <meta name="apple-mobile-web-app-title" content="@ohif/app" />
  ...
  <script rel="preload" as="script" type="module" src="/init-service-worker.js"></script>
  ...
  <script defer="defer" src="/app.bundle.5282d0acd7f22295a5a5.js"></script>
